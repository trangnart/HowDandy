class Guide extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(game.config.width/2, game.config.height/2, 'hit ground =        health', wordConfig).setOrigin(1.29, -1.06);
        this.add.text(game.config.width/2, game.config.height/2, '-1', redConfig).setOrigin(6.6, -1.06);
        ...
        this.add.text(game.config.width/2, game.config.height/2, 'hit bird =        health', wordConfig).setOrigin(1.43, -8);
        this.add.text(game.config.width/2, game.config.height/2, '-1', redConfig).setOrigin(7.45, -8);
        this.add.text(game.config.width/2, game.config.height/2, 'collect seed =         health', wordConfig).setOrigin(-0.5, 6);
        ...
        this.add.text(game.config.width/2, game.config.height/2, 'drop seed at water =      point', word2Config).setOrigin(-0.5, -5);
