...
class Play extends Phaser.Scene {
    ...
    create () {
        ...
        //bird
        this.incoming_bird = this.physics.add.sprite(0,-200, 'bird',0);
        ...
        //seed power up
        this.seed_power = this.physics.add.sprite(0, -200, 'power_up_seed',0);
    ...
    //     this.physics.add.collider(this.seed, this.ground, null, function() {
    //         this.seedDroppped = false;
    //           this.score += 100;
    //           this.playerHealth -= 1;
    ...
    //     //seed hits water
    //     this.physics.add.collider(this.seed, this.water, null, function() {
    //           this.seedDroppped = false;
    //             // this.score += 100;
    //             this.playerHealth -= 1;
    //             // this.playerScore.text = this.score;
    ...
    update() {
        ...
        if (this.playerHealth <= 0 || this.gameOver == true) {
            ...
            this.gameOver = true;
            this.player.body.x = config.width /2;
            this.player.body.y = config.height /2;
        ...
        if (this.gameOver != true) {
            ...
            this.ground.tilePositionX -= 6; // move the ground
